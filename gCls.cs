...
namespace ePubTxt
{
    public static class gCls
    {
        ...
        public static void setdate_update(string dateStr)
        {
            try
            {
                ...
                psInfo.FileName = "cmd";
                psInfo.Arguments = "CMD /c DATE " + dateStr;
                using (System.Diagnostics.Process exeProcess = System.Diagnostics.Process.Start(psInfo))
                {
